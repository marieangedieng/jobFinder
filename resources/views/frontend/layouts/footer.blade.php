    ...
    <div class="container" >
        <div class="box-newsletter" >
            <div class="newsletter_textarea" >
                <div class="row" >
                    <div class="col-lg-6">
                        <h2 class="text-md-newsletter" style="color: #012A4A; ">Subscribe our newsletter</h2>
                    </div>
                    <div class="col-lg-6">
                        <div class="box-form-newsletter">
                            <form class="form-newsletter">
                                ...
                                <button type="submit" class="btn btn-default font-heading newsletter-btn" style="background-color:#0093c6" onmouseover="this.style.backgroundColor='#012A4A'"  onmouseout="this.style.backgroundColor='#0093c6'">Subscribe</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-between" >
            ...
            <div class="footer-col-1 col-md-3 col-sm-12">
                <a class="footer_logo" href="index.html">
                    <img alt="jobFinder" src="{{ $footerDetails?->logo }}">
                </a>
