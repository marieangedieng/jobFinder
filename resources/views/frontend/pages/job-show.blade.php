...
@section('contents')
    <section class="section-box mt-150">
        <p style="font-size: 50px; font-weight: bold; text-align: center; color: black">A job offer!</p>
        <p style="text-align: center; color: black; margin-top: 20px">Maybe this is your dream job !</p>
    </section>

  <section class="section-box-2">
    <div class="container">
      <div class="banner-hero banner-image-single"><img style="height: 300px;object-fit: cover;" src="{{ asset($job->company->banner) }}" alt=JobFinder>
      </div>
      <div class="row mt-10">
          ...
          <div class="job-overview">
            ...
            <div class="row">
              <div class="col-md-6 d-flex">
                <div class="sidebar-icon-item"><img src="{{ asset('frontend/assets/imgs/page/job-single/industry.svg') }}" alt=JobFinder>
                </div>
              ...
              <div class="col-md-6 d-flex mt-sm-15">
                <div class="sidebar-icon-item"><img src="{{ asset('frontend/assets/imgs/page/job-single/job-level.svg') }}" alt=JobFinder>
                </div>
            ...
            <div class="row mt-25">
              <div class="col-md-6 d-flex mt-sm-15">
                <div class="sidebar-icon-item"><img src="{{ asset('frontend/assets/imgs/page/job-single/salary.svg') }}" alt=JobFinder></div>
                <div class="sidebar-text-info ml-10"><span
              ...
              <div class="col-md-6 d-flex">
                <div class="sidebar-icon-item"><img src="{{ asset('frontend/assets/imgs/page/job-single/experience.svg') }}" alt=JobFinder>
                </div>
                <div class="sidebar-text-info ml-10"><span
            ...
            <div class="row mt-25">
              <div class="col-md-6 d-flex mt-sm-15">
                <div class="sidebar-icon-item"><img src="{{ asset('frontend/assets/imgs/page/job-single/job-type.svg') }}" alt=JobFinder>
                </div>
              ...
              <div class="col-md-6 d-flex mt-sm-15">
                <div class="sidebar-icon-item"><img src="{{ asset('frontend/assets/imgs/page/job-single/deadline.svg') }}" alt=JobFinder>
                </div>
            ...
            <div class="row mt-25">
              <div class="col-md-6 d-flex mt-sm-15">
                <div class="sidebar-icon-item"><img src="{{ asset('frontend/assets/imgs/page/job-single/updated.svg') }}" alt=JobFinder></div>
                <div class="sidebar-text-info ml-10"><span
                    class="text-description jobtype-icon mb-10">Education</span><strong
                    class="small-heading">{{ $job->jobEduction?->name }}</strong></div>
              </div>
              <div class="col-md-6 d-flex mt-sm-15">
                <div class="sidebar-icon-item"><img src="{{ asset('frontend/assets/imgs/page/job-single/location.svg') }}" alt=JobFinder>
                </div>
          ...
          <div class="single-apply-jobs">
            <div class="row align-items-center">
              ...
              <div class="col-md-7 text-lg-end social-share">
                ...
                <a data-social="facebook" class="mr-5 d-inline-block d-middle" href="#"><img alt=JobFinder src="{{ asset('frontend/assets/imgs/template/icons/share-fb.svg') }}"></a>
                <a data-social="twitter" class="mr-5 d-inline-block d-middle" href="#"><img alt=JobFinder src="{{ asset('frontend/assets/imgs/template/icons/share-tw.svg') }}"></a>
                <a data-social="reddit" class="mr-5 d-inline-block d-middle" href="#"><img alt=JobFinder src="{{asset('frontend/assets/imgs/template/icons/share-red.svg')}}"></a>
                <a data-social="linkedin" class="d-inline-block d-middle" href="#"><img alt=JobFinder src="{{ asset('frontend/assets/imgs/template/icons/share-in.svg') }}"></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="sidebar-border">
            <div class="sidebar-heading">
              <div class="avatar-sidebar">
                <figure><img alt=JobFinder src="{{ asset($job->company->logo) }}"></figure>
