...
@section('contents')
    <section class="section-box mt-200">
        <p style="font-size: 50px; font-weight: bold; text-align: center; color: black">Search for your dream job!</p>
        <p style="text-align: center; color: black; margin-top: 20px">Whatever the industry, place or wage you are looking for !</p>
    </section>
                                            ...
                                            <div class="card-2-bottom mt-20">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7 col-7"><span
                                                        class="card-text-price" style="color: #0093c6">
                            ...
                            <div class="filter-block mb-20">
                                <div class="form-group select-style">
                                    ...
                                    <button class="submit btn btn-default mt-10 rounded-1 w-100"
                                        type="submit" style="background-color: #0093c6">Search</button>
                                </div>
                            </div>
                            </form>
