...
@section('contents')
    <section class="section-box mt-150">
        <p style="font-size: 50px; font-weight: bold; text-align: center; color: black">Company Details!</p>
        <p style="text-align: center; color: black; margin-top: 20px">More about this recruiter !</p>
    </section>

  <section class="section-box-2">
    <div class="container">
      <div class="banner-hero banner-image-single"><img style="height: 374px; object-fit: cover;" src="{{ asset($company->banner) }}" alt=JobFinder></div>
