<section class="section-box mt-80">
    <div class="container">
        <div class="text-center">
            ...
            <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Your dream place, with your dream job? What a dream!</p>
        </div>
    </div>
    <div class="container">
        <div class="row mt-50">
                ...
                <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                    <div class="card-image-top hover-up"><a href="{{ route('companies.index', ['country' => $location->country_id]) }}">
                            <div class="image" style="background-image: url({{ asset($location->image) }});"><span
                                    class="lbl-hot" style="background-color: #0093c6">{{ $location->status }}</span></div>
                        </a>
