<section class="section-box why_choose mt-95 pt-90 mb-20" style="background-color: #E3F2FD">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="box-step step-1">
              ...
              <p class="font-lg color-text-paragraph-2">{{ $whyChooseUs?->sub_title_one }}</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="box-step step-2">
              ...
              <p class="font-lg color-text-paragraph-2">{{ $whyChooseUs?->sub_title_two }}</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="box-step border-0">
              ...
              <p class="font-lg color-text-paragraph-2">{{ $whyChooseUs?->sub_title_three }}</p>
            </div>
          </div>
        </div>
      </div>
