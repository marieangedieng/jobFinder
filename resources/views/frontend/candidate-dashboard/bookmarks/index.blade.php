...
@section('contents')
    <section class="section-box mt-200">
        <p style="font-size: 50px; font-weight: bold; text-align: center; color: black">BookMarks!</p>
        <p style="text-align: center; color: black; margin-top: 20px">Where you keep your interests !</p>
    </section>
