...
@section('contents')
    <section class="section-box mt-150">
        <p style="font-size: 50px; font-weight: bold; text-align: center; color: black">Your space!</p>
        <p style="text-align: center; color: black; margin-top: 20px">Keep your informations up to date !</p>
    </section>
