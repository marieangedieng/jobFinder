...
<section class="section-box mt-200">
        ...
        <p style="font-size: 50px; font-weight: bold; text-align: center; color: black">Welcome Back!</p>
        <p style="text-align: center; color: black; margin-top: 20px">We are happy to see you again :) !</p>
        ...
        <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
          <div class="login-register-cover">
            ...
            <form class="login-register text-start mt-20" method="POST" action="{{ route('login') }}">
              ...
              <div class="form-group">
                <button class="btn btn-default hover-up w-100" type="submit" name="login" style="background-color: #0093c6; font-weight: bold" onmouseover="this.style.backgroundColor='#012A4A'"  onmouseout="this.style.backgroundColor='#0093c6'" >Login</button>
              </div>
